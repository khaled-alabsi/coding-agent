...
When migrating KWK to a microservice, you need to identify and replicate:

### 8.1 Database Tables
- Find all `@Entity` classes used
- Export table schemas
- Migrate to new microservice database

### 8.2 External API Calls
- Identify all `RestClient` dependencies
- Copy client implementations
- Configure endpoints and credentials

### 8.3 SC Service Dependencies
- List all injected SC services
- Decide: replicate or call via API gateway
- May need to convert to REST calls

### 8.4 Mainframe Access
- Identify MNC calls
- May need to create wrapper APIs
- Consider keeping in monolith initially
